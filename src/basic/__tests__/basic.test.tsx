...
import { useCoupons, useProducts } from '../../refactoring/_hooks';
import * as cartUtils from '../../refactoring/_models/cart';
import useCouponSelect from '../../refactoring/Cart/_hooks/useCouponSelect';
import { useCart } from '../../refactoring/Cart/_hooks/useCart';
...
describe('basic > ', () => {
  ...
  describe('useCart > ', () => {
    ...
    test('합계를 정확하게 계산해야 합니다', () => {
      ...
      const { result: couponResult } = renderHook(() => useCouponSelect());
      ...
      const total = cartResult.current.calculateTotal(couponResult.current.selectedCoupon);
