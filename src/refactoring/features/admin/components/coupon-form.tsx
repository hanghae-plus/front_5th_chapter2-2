...
export const CouponForm = ({ newCoupon, setNewCoupon, onAddCoupon }: CouponFormProps) => {
  return (
    <div className="space-y-2 mb-4">
      ...
      <button onClick={onAddCoupon} className="w-full bg-green-500 text-white p-2 rounded hover:bg-green-600">
        쿠폰 추가
      </button>
    </div>
  );
