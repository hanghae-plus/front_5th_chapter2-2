...
const CouponManage = (props: CouponManageProps) => {
  const { coupons, onCouponAdd } = props;
  const { newCoupon, updateCouponField, handleAddCoupon } = useNewCoupon({ onCouponAdd });
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="flex gap-2">
            <select
              ...
              onChange={(e) =>
                updateCouponField('discountType', e.target.value as 'amount' | 'percentage')
              }
              className="w-full p-2 border rounded">
