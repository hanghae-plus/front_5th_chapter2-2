import { TotalDiscount } from '../../types';
interface CartSummaryProps {
    discountSummary: TotalDiscount;
}

const CartSummary = ({ discountSummary }: CartSummaryProps) => {
    const { totalBeforeDiscount, totalAfterDiscount, totalDiscount } = discountSummary;
    return (
