...
import CartCouponApplied from './CouponApplied';
import CartCouponSelectBox from './CouponSelectBox';
...
function CartCoupon({ coupons, applyCoupon, selectedCoupon }: Props) {
  return (
    <div className='mt-6 bg-white p-4 rounded shadow'>
      ...
      {selectedCoupon && <CartCouponApplied selectedCoupon={selectedCoupon} />}
    </div>
  );
}
